...
const (
	ServiceService_CreateService_FullMethodName = "/nimbuscore.v1.ServiceService/CreateService"
	ServiceService_GetService_FullMethodName    = "/nimbuscore.v1.ServiceService/GetService"
	ServiceService_ListServices_FullMethodName  = "/nimbuscore.v1.ServiceService/ListServices"
	ServiceService_DeleteService_FullMethodName = "/nimbuscore.v1.ServiceService/DeleteService"
)
...
func (c *serviceServiceClient) CreateService(ctx context.Context, in *CreateServiceRequest, opts ...grpc.CallOption) (*Service, error) {
...
func (UnimplementedServiceServiceServer) CreateService(context.Context, *CreateServiceRequest) (*Service, error) {
...
var ServiceService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "nimbuscore.v1.ServiceService",
