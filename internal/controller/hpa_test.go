...
func newTestHPA() (*HorizontalAutoscaler, *registry.Registry[*v1.Deployment], *registry.Registry[*v1.Pod]) {
	s := store.NewMemStore()
	...
	return NewHorizontalAutoscaler(deployments, pods, 0), deployments, pods
}
